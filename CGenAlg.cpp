                                ...
                                vector<double>       &baby2)
{
  //just return parents as offspring dependent on the rate
	...
	int cp1 = RandInt(0, m_vecSplitPoints.size() - 2); //m_vecSplitPoints[RandInt(0, m_vecSplitPoints.size()-2)];
	int cp2 = RandInt(cp1, m_vecSplitPoints.size() - 1);//m_vecSplitPoints[RandInt(cp1, m_vecSplitPoints.size()-1)];
